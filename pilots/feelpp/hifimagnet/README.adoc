...
image:{imagesdir}/media/image11.jpeg[setup_lowres.jpg,width=180,height=240]image:{imagesdir}/media/image12.png[elevator2+zoom.png,width=187,height=242]
...
image:{imagesdir}/media/image13.png[exp_Bprofil.png,width=399,height=311]
