= MSO4SC: TOSCA Modelling and execution
:page-root: ../../../
:page-permalink: /tosca/
:page-layout: default
...
If an error occur in some of the steps above, or you simply want to uninstall the application, recreate the deployment with new inputs, or remove the blueprint (and possibly upload an updated one), follow the following steps.
